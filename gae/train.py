...
# savedir = 'gae/data/saved/negative_to_pos_100/pos_weight_1/'
savedir = 'gae/data/saved/'
with open(savedir+'disease_network_mean.npy', 'wb') as f:
  np.save(f, outs[0])
with open(savedir+'disease_network_log_std.npy', 'wb') as f:
  np.save(f, outs[1])
with open(savedir+'disease_network_z.npy', 'wb') as f:
  np.save(f, outs[2])
with open(savedir+'disease_network_y.npy', 'wb') as f:
  np.save(f, outs[3]) 
